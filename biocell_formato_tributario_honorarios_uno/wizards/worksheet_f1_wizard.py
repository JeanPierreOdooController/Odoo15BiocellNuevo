...
class WorksheetF1Wizard(models.TransientModel):
	...
	def get_window_f1_register(self):
		view = self.env.ref('biocell_formato_tributario_honorarios_uno.view_f1_register_tree').id
		return {
	...
	def get_window_f1_balance(self):
		view = self.env.ref('biocell_formato_tributario_honorarios_uno.view_f1_balance_tree').id
		return {
