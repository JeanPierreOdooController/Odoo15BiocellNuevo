...
class AccountMove(models.Model):
	...
	def write(self, vals):
		res = True
		for move in self:
			if 'access_token' in vals or 'amount_untaxed' in vals or 'amount_tax' in vals or 'amount_total' in vals or 'amount_residual' in vals or 'amount_untaxed_signed' in vals or 'amount_tax_signed' in vals or 'amount_total_signed' in vals or 'amount_residual_signed' in vals or 'payment_state' in vals or 'x_studio_factura_internada' in vals or 'x_studio_fecha_de_factura_internada' in vals or 'x_studio_fecha_bcp' in vals:
