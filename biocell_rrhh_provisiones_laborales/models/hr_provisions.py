...
class HrProvisiones(models.Model):
	...
	def get_provisions_wizard(self):
		...
		return {
			...
			'views': [(self.env.ref('biocell_rrhh_provisiones_laborales.biocell_rrhh_provisiones_laborales_wizard_form').id, 'form')],
...
class CtsLineWizard(models.Model):
	...
	def get_wizard(self,employee_id,provision_id,line_id):
		...
		return {
			...
			'views':[[self.env.ref('biocell_rrhh_provisiones_laborales.cts_line_wizard').id,'form']],
			'target':'new',
			'context':{
...
class GratiLineWizard(models.Model):
	...
	def get_wizard(self,employee_id,provision_id,line_id):
		...
		return {
			...
			'views':[[self.env.ref('biocell_rrhh_provisiones_laborales.grati_line_wizard').id,'form']],
			'target':'new',
			'context':{
				'default_employee_id':employee_id,
				'default_provision_id':provision_id,
...
class VacaLineWizard(models.Model):
	...
	def get_wizard(self,employee_id,provision_id,line_id):
		...
		return {
			...
			'views':[[self.env.ref('biocell_rrhh_provisiones_laborales.vaca_line_wizard').id,'form']],
			'target':'new',
			'context':{
				'default_employee_id':employee_id,
				'default_provision_id':provision_id,
