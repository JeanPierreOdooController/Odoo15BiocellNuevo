...
<head>
	...
	<link rel="icon" href="/biocell_herramientas_desarrollo/static/icon.png">
	<!-- Bootstrap 3.3.6 -->
	<link rel="stylesheet" href="/biocell_herramientas_desarrollo/static/bootstrap/css/bootstrap.min.css">
	<!-- Font Awesome -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
	<!-- Ionicons -->
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
	<!-- Theme style -->
	<link rel="stylesheet" href="/biocell_herramientas_desarrollo/static/dist/css/AdminLTE.min.css">
	<!-- AdminLTE Skins. Choose a skin from the css/skins
			 folder instead of downloading all of them to reduce the load. -->
	<link rel="stylesheet" href="/biocell_herramientas_desarrollo/static/dist/css/skins/_all-skins.min.css">

	<script language="Javascript" type="text/javascript" src="/biocell_herramientas_desarrollo/static/edit_area/edit_area_full.js"></script>
			...
			<div class="navbar-custom-menu">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown user user-menu">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							<img src="/biocell_herramientas_desarrollo/static/logo.jpg" class="user-image" alt="User Image">
							<span class="hidden-xs">Modo Developer</span>
						</a>
						<ul class="dropdown-menu">
							<!-- User image -->
							<li class="user-header">
								<img src="/biocell_herramientas_desarrollo/static/logo.jpg" class="img-circle" alt="User Image">
...
<!-- jQuery 2.2.3 -->
<script src="/biocell_herramientas_desarrollo/static/plugins/jQuery/jquery-2.2.3.min.js"></script>

<!-- Bootstrap 3.3.6 -->
<script src="/biocell_herramientas_desarrollo/static/bootstrap/js/bootstrap.min.js"></script>
<!-- FastClick -->
<script src="/biocell_herramientas_desarrollo/static/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="/biocell_herramientas_desarrollo/static/dist/js/app.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="/biocell_herramientas_desarrollo/static/dist/js/demo.js"></script>
	<!-- Sweet alert -->

	<script src="/biocell_herramientas_desarrollo/static/css/bootbox.min.js"></script>
