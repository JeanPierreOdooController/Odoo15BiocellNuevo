	...
	def reportxls_sunat(self):
		...
		for line in self.env.cr.fetchall():
			if line[21] != almacen_index or line[9] != product_index:
				...
				linea = [border(ws,u"Fecha"),border(ws,u"Tipo"),border(ws,u"Serie"),border(ws,u"Numero"),border(ws,u"Tipo de operación"),border(ws,u"Cliente / Proveedor"),border(ws,u"Entrada Cantidad"),border(ws,u"Salida Cantidad"),border(ws,u"Saldo Final Cantidad"),border(ws,u"Lote")]
