...
class StockQuant(models.Model):
    ...
    def check_negative_qty(self):
        ...
        check_negative_qty = (
            config["test_enable"] and self.env.context.get("test_biocell_control_stock_negativo")
        ...
        for quant in self:
            ...
            if (
                ...
                and (quant.location_id.usage in ["internal", "transit"] or quant.location_id.id == 39 )
