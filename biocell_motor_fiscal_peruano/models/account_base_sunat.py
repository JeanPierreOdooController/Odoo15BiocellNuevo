	...
	def _get_sql(self,type,period_id,company_id):
		...
		if type in (4,5):
			...
			sql = """ SELECT T.* FROM (SELECT 
					...
					END AS campo9,
					CASE
						WHEN vst_d.td_sunat is not null and vst_d.td_sunat <> '09' THEN vst_d.td_sunat
						ELSE '00'
					END AS campo10,
					CASE
					...
					CASE WHEN vst_d.td_sunat is not null and vst_d.td_sunat <> '09' THEN vst_d.td_sunat ELSE '00' END AS campo10,
