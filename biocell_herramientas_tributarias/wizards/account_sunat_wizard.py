...
class AccountSunatWizard(models.TransientModel):
	...
	def _get_ple(self,type):
		...
		res = ReportBase.get_file_biocell_descarga_consultas_sql(sql_ple,'|')
	...
	def get_txt_pdt(self,type,company_id,date_start,date_end):
		...
		ReportBase = self.env['report.base']
		res = ReportBase.get_file_biocell_descarga_consultas_sql(sql_query,'|')
	...
	def get_excel_81(self):
		...
		workbook = ReportBase.get_excel_biocell_descarga_consultas_sql(sql_ple,['CAMPO 1','CAMPO 2','CAMPO 3','CAMPO 4','CAMPO 5','CAMPO 6','CAMPO 7','CAMPO 8','CAMPO 9',
	...
	def get_excel_82(self):
		...
		workbook = ReportBase.get_excel_biocell_descarga_consultas_sql(sql_ple,['CAMPO 1','CAMPO 2','CAMPO 3','CAMPO 4','CAMPO 5','CAMPO 6','CAMPO 7','CAMPO 8',
