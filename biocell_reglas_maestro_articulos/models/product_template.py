...
class product_template(models.Model):
	...
	def unlink(self):
		if self.env.user.has_group("biocell_reglas_maestro_articulos.group_product_template_restriction"):
...
class purchase_order(models.Model):
	...
	def _add_supplier_to_product(self):
		if self.env.user.has_group("biocell_reglas_maestro_articulos.group_product_template_restriction"):
			...
			grupo_editor = self.env.ref('biocell_reglas_maestro_articulos.group_product_template_restriction')
