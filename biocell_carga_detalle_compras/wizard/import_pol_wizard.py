...
class import_pol_wizard(models.TransientModel):
	...
	# VERSION ANTIGUA CAMBIO REALIZADO EL 14/11/23
	...
	product_by = fields.Selection([
		('int_ref', 'Referencia Interna')
		], default="int_ref", string="Producto por", required=True) 
	...
	def show_success_msg(self, counter, skipped_line_no):
		...
		action = self.env.ref('biocell_carga_detalle_compras.sh_import_pol_action').read()[0]
