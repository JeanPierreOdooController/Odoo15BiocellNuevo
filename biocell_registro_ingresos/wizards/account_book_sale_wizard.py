	...
	def get_report(self):
		...
		if self.type_show == 'pantalla':
			...
			if self.currency == 'pen':
				view_id = self.env.ref('biocell_registro_ingresos.view_account_book_sale_view_tree')
			else:
				view_id = self.env.ref('biocell_registro_ingresos.view_account_book_sale_usd_view_tree')
			return {
