		...
		if self.type_show:
			...
			if self.type_show == 'pantalla':
				return {
					...
					'view_mode': 'tree',
					'view_id': self.env.ref('account_sale_rep_it.view_account_sale_book_tree').id if self.currency == 'pen' else self.env.ref('biocell_control_importes_extranjeros.view_account_sale_book_usd_tree').id,
				}
