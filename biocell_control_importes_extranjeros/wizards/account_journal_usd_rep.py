		...
		if self.type_show == 'pantalla':
			if self.level == 'register':
				...
				return {
					...
					'view_mode': 'tree',
					'views': [(self.env.ref('biocell_control_importes_extranjeros.view_f1_register_usd_tree').id, 'tree')],
					}
			else:
				...
				return {
					...
					'view_mode': 'tree',
					'views': [(self.env.ref('biocell_control_importes_extranjeros.view_f1_balance_usd_tree').id, 'tree')],
					}
		else:
