...
class KardexEntryIncomeWizard(models.TransientModel):
	_inherit = 'kardex.entry.income.wizard'
	...
	def get_report(self):
		...
		self.env.cr.execute("""
		INSERT INTO kardex_entry_income_book (fecha,tipo,serie,numero,doc_almacen,ruc,empresa,tipo_op,tipo_name, producto, default_code, unidad, qty, amount, cta_debe, cta_haber, origen, destino, almacen, analytic_account_id,analytic_tag_id,lot) 
