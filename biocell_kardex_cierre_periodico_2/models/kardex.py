	...
	left join (
		...
		for xl in total_all:
			...
			if producto == None:
				...
				almacen = l['almacen']
				lote = l['lot_id']
			if producto != 	l['product_id'] or almacen != l['almacen'] or lote != l['lot_id']:
				producto = l['product_id']
				almacen = l['almacen']	
				lote = l['lot_id']
				if array_grabar:			
			...
			linea.append( l['lot_id'] if l['lot_id'] else 0 )
...
select 
	...
	left join (
		...
		for xl in total_all:
			...
			linea.append( l['location_id'] if l['location_id'] else '' )
			linea.append( l['lot_id'] if l['lot_id'] else '' )
			array_grabar = linea.copy()
