...
class AccountMove(models.Model):
    ...
    def action_invoice_sent(self):
        ...
        template = self.env.ref('biocell_pe_facturacion_electronica.email_template_edi_invoice', raise_if_not_found=False)
        if template:
    ...
    def _get_name_invoice_report(self):
        ...
        if self.company_id.country_id.code == 'PE' and self.l10n_pe_dte_is_einvoice:
            return 'biocell_pe_facturacion_electronica.report_einvoice_document'
...
class AccountMoveLine(models.Model):
    ...
    def _l10n_pe_prepare_dte_lines(self):
        ...
        if self.product_id:
            line['product_category'] = self.product_id.categ_id.name
    ...
    def show_detail_anticipo(self):
        ...
        view = self.env.ref('biocell_pe_facturacion_electronica.detail_anticipo', False)
