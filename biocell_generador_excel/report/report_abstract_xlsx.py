...
try:
    ...
    class PatchedXlsxWorkbook(openpyxl.Workbook):
        def _check_sheetname(self, sheetname, is_chartsheet=False):
            ...
            try:
            ...
            except openpyxl.exceptions.DuplicateWorksheetName:
                ...
                if duplicated_secuence > 99:
                    raise openpyxl.exceptions.DuplicateWorksheetName  # noqa: B904
    ...
    openpyxl.Workbook = PatchedXlsxWorkbook
...
class ReportXlsxAbstract(models.AbstractModel):
    _name = "report.biocell_generador_excel.abstract"
    ...
    def _biocell_generador_excel_currency_format(self, currency):
