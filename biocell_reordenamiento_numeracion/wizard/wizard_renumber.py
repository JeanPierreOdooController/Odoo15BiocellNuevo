...
class WizardRenumber(models.TransientModel):
	...
	journal_ids = fields.Many2many('account.journal','biocell_reordenamiento_numeracion_journal_rel','id_wizard_renumber','id_journal_wizard',string=u'Libros', required=True)
