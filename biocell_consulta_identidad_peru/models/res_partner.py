...
class ResPartner(models.Model):
	...
	is_partner_perception = fields.Boolean(string="Agente de Percepción")
	good_taxpayer = fields.Boolean(string="Buen Contribuyente")
	executing_unit = fields.Boolean(string='Unidad Ejecutora', default=False)
		...
		for self in selfs:
			if self.l10n_latam_identification_type_id.code_sunat == '6':
				...
				if parameters.query_supplier == '1':
					...
					self.is_partner_perception = u"Incorporado al Régimen de Agentes de Percepción" in content_ruc[17]
					self.good_taxpayer = u"Incorporado al Régimen de Buenos Contribuyentes" in content_ruc[17]
