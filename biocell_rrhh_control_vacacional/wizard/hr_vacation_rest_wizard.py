	...
	def make_vacation_rest(self):
		...
		if self.type_show =='pantalla':
			...
			c={
				...
				'view_type': 'form',
				'view_mode': 'tree',
				'views': [(self.env.ref('biocell_rrhh_control_vacacional.hr_vacation_rest_tree_resumen').id, 'tree')],
				'search_view_id':[self.env.ref('biocell_rrhh_control_vacacional.hr_vacation_rest_search').id, 'search'],
				'domain':domain
				}
			# print(c)
			return c
