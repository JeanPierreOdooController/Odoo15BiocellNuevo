...
class hr_quincenales_lines(models.Model):
	...
	def ingresos_wizard(self):
		view_id = self.env.ref('biocell_rrhh_proceso_quincenal.view_hr_quincenales_lines_ing_form', False)
	...
	def descuentos_wizard(self):
		view_id = self.env.ref('biocell_rrhh_proceso_quincenal.view_hr_quincenales_lines_desc_form', False)
		return {'type':'ir.actions.act_window',
				'res_model':'hr.quincenales.lines',
				'res_id':self.id,
				'view_id':view_id.id,
	...
	def conceptos_wizard(self):
		view_id = self.env.ref('biocell_rrhh_proceso_quincenal.view_hr_quincenales_lines_conceptos_form', False)
		return {'type':'ir.actions.act_window',
				'res_model':'hr.quincenales.lines',
				'res_id':self.id,
				'view_id':view_id.id,
