...
class biocell_panel_saldos_financieros_4_multipleorigin(models.TransientModel):
...
class alberan_button(models.Model):
    ...
    def action_name(self):
        ...
        return {
            ...
            'view_mode': 'tree',
            'view_type': 'form',
            'view_id':self.env.ref('biocell_acceso_guia_operacion_mrp.insumostree_nolote').id,
...
class StockBalanceReportLote(models.Model):
    ...
    def action_name(self):
        ...
        return {
            ...
            'view_mode': 'tree',
            'view_type': 'form',
            'view_id':self.env.ref('biocell_acceso_guia_operacion_mrp.insumostree').id,
            # 'context': "{'name':'cemento'}",
            'type': 'ir.actions.act_window',
            'target': 'current',
            'domain': [('id', 'in', ids_domain)]
