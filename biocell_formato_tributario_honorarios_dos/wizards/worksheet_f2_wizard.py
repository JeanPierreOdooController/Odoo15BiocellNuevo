...
class WorksheetF2Wizard(models.TransientModel):
	...
	def get_window_f2_register(self):
		view = self.env.ref('biocell_formato_tributario_honorarios_dos.view_f2_register_tree').id
		return {
	...
	def get_window_f2_balance(self):
		view = self.env.ref('biocell_formato_tributario_honorarios_dos.view_f2_balance_tree').id
		return {
