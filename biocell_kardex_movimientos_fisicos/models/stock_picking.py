...
class stock_move(models.Model):
	...
	def change_mostrar_b(self):
		return {
			...
			'target': 'new',
			'res_id': self.id,
			'views': [(self.env.ref('biocell_kardex_movimientos_fisicos.stockmove_editno_mostrar').id, 'form')],
		}
	...
	def actualizar_kardex_date_b(self):		
		return {
			...
			'target': 'new',
			'res_id': self.id,
			'views': [(self.env.ref('biocell_kardex_movimientos_fisicos.stockmove_editkardex_date').id, 'form')],
		}
