...
class TestMassEditing(common.TransactionCase):
    def setUp(self):
        ...
        self.biocell_edicion_masiva_registros_user = self.env.ref("biocell_edicion_masiva_registros.biocell_edicion_masiva_registros_user")
        self.biocell_edicion_masiva_registros_partner_title = self.env.ref(
            "biocell_edicion_masiva_registros.biocell_edicion_masiva_registros_partner_title"
        )
    ...
    def test_wzd_default_get(self):
        ...
        wzd_obj = self.MassEditingWizard.with_context(
            server_action_id=self.biocell_edicion_masiva_registros_user.id,
            active_ids=[1],
    ...
    def test_wiz_read_fields(self):
        ...
        mass_wizard = self._create_wizard_and_apply_values(
            self.biocell_edicion_masiva_registros_user, self.users, vals
        )
    ...
    def test_mass_edit_partner_title(self):
        ...
        self._create_wizard_and_apply_values(
            self.biocell_edicion_masiva_registros_partner_title, self.partner_title, vals
        )
        self.assertEqual(
    ...
    def test_mass_edit_email(self):
        ...
        vals = {"selection__email": "remove", "selection__phone": "remove"}
        self._create_wizard_and_apply_values(self.biocell_edicion_masiva_registros_user, self.user, vals)
    ...
    def test_check_field_model_constraint(self):
        ...
        with self.assertRaises(ValidationError):
            self.biocell_edicion_masiva_registros_user.write(
    ...
    def test_onchanges(self):
        ...
        server_action_form = Form(self.biocell_edicion_masiva_registros_user)
        self.assertGreater(
        ...
        mass_edit_line_form = Form(
            self.env.ref("biocell_edicion_masiva_registros.biocell_edicion_masiva_registros_user_line_1")
        )
