...
class PdfOrientation(models.TransientModel):
    ...
    def print_pdf(self):
        ...
        action_print_pdf = self.env.ref('biocell_consultas_generales.action_print_pdf')

        if self.orientation == 'landscape':
            action_print_pdf.paperformat_id = self.env.ref('biocell_consultas_generales.paperformat_landscape').id
        elif self.orientation == 'portrait':
            action_print_pdf.paperformat_id = self.env.ref('biocell_consultas_generales.paperformat_portrait').id
