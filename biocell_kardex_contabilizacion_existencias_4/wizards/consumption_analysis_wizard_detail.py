...
class ConsumptionAnalysisWizardDetail(models.TransientModel):
	...
	def get_report(self):
		...
		self.env.cr.execute("""
		INSERT INTO consumption_analysis_book_detail (almacen,doc,date,producto,origen,destino,analytic_account_id,analytic_tag_id,cantidad, valor, valuation_account_id, input_account_id, user_id) 
